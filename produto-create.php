              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class='mb-3'>
                    ...
                    <div class="image-preview-container border p-2 text-center border p-4 text-center d-flex flex-column justify-content-center align-items-center">
                      <img id="imagemPreview"
                        src="#"
                        alt="Pré-visualização da Imagem"
                        style="display: none; max-width: 100%; max-height: 200px; object-fit: contain;">
                      <p id="textoPlaceholder">Nenhuma imagem selecionada.</p>
                    </div>
                  </div>
                </div>
